...
export const listNotes = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://note-maker-app.herokuapp.com/api/notes`, config);
    ...
    const message =
      ...
      export const createNoteAction = (title, content, category) => async (
        ...
        try {
          ...
          const { data } = await axios.post(
            `https://note-maker-app.herokuapp.com/api/notes/create`,
      ...
      export const deleteNoteAction = (id) => async (dispatch, getState) => {
        try {
          ...
          const { data } = await axios.delete(`https://note-maker-app.herokuapp.com/api/notes/${id}`, config);
      ...
      export const updateNoteAction = (id, title, content, category) => async (
        ...
        try {
          ...
          const { data } = await axios.put(
            `https://note-maker-app.herokuapp.com/api/notes/${id}`,
            { title, content, category },
            config
          );
