...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            "https://note-maker-app.herokuapp.com/api/users/login",
            { email, password },
            config
        );
...
export const register = (name,email, password,pic) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            "https://note-maker-app.herokuapp.com/api/users",
...
export const updateProfile = (user) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post("https://note-maker-app.herokuapp.com/api/users/profile", user, config);
